...
public class Withdraw{
    ...
    public Withdraw(String userId){
        ...
        Font f3 = new Font ("Ariel",Font.BOLD,20);
        Font f4 = new Font ("Ariel",Font.BOLD,15);
        ...
        bt2.addActionListener(new ActionListener() {
            ...
            // if (tf1.getText()!=null && tf2.getText()!=null) {
                ...
                final String query = "select `id`, `Password` , `Balance` from `balance` ; " ;
                ...
                try
    {
        ...
        while(rs.next())
        {
            ...
            if(userId.equals(l4.getText()) && password.equals(tf1.getText()))
            {
                ...
                if (Integer.parseInt(tf2.getText()) <= Integer.parseInt(balance)  ){
